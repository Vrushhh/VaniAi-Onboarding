...
export const SARVAM_ORG_ID = process.env.SARVAM_ORG_ID || "019ef441-dafb-7f96-9184-64c5716c4e15";
export const SARVAM_WORKSPACE_ID = process.env.SARVAM_WORKSPACE_ID || "019ef441-daff-7ab7-aa42-48cb2b90b4f8";
...
export function getSarvamAgentConfig() {
  return {
    ...
    agent_variables: {
      ...
      call_summary: "Live KZUNO Voice Agent Demo Call",
    },
...
export class SarvamSessionAdapter {
  constructor(bridge) {
    ...
    this.orgId = SARVAM_ORG_ID;
    this.workspaceId = SARVAM_WORKSPACE_ID;
    this.agentVariables = {
      user_name: "Caller",
      call_summary: "KZUNO Onboarding Call",
    };
